    ...
    <footer className="w-full flex justify-center items-end p-8 pb-12 bg-transparent mt-32">
      <div className="footer-card bg-[#181926]/90 rounded-3xl shadow-2xl px-8 py-10 max-w-xl w-full flex flex-col items-start gap-6 relative" style={{backdropFilter:'blur(24px)', WebkitBackdropFilter:'blur(24px)'}}>
        ...
        <div className="flex items-center gap-4 mt-2">
          <Image src="/jonathan.avif" alt="Jonathan Reed" width={56} height={56} className="rounded-full border-2 border-[#a78bfa]" unoptimized />
          <a href="https://helloworldfirm.com" target="_blank" className="flex items-center gap-2 text-[#a78bfa] text-lg font-medium hover:underline">
            <Image src="/logo.avif" alt="Logo" width={28} height={28} className="rounded-full" unoptimized />
            helloworldfirm.com
          </a>
        </div>
